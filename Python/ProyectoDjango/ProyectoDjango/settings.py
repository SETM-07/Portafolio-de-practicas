...
SECRET_KEY = '%dpbaa-(z#02505(%$+1(u=uyv9_b2@yiy8%h_&dysikvmv!@6'
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar_Custom': [
            ...
            ['Link', 'Unlink'],
            ['RemoveFormat', 'Source','Image', 'Table', 'HorizontalRule','Smiley', 'SpecialChar', 'PageBreak', 'Iframe', 'Abbr', 'uicolor']
        ]
    }
}
